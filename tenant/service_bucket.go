...
func (s *BucketSvc) FindBuckets(ctx context.Context, filter influxdb.BucketFilter, opt ...influxdb.FindOptions) ([]*influxdb.Bucket, int, error) {
	...
	fmt.Println("offset 1: ", o.Offset)
	fmt.Println("limit 1: ", o.Limit)
	...
	fmt.Println("offset 2: ", o.Offset)
	fmt.Println("limit 2: ", o.Limit)
	...
	fmt.Println("offset 3: ", o.Offset)
	fmt.Println("limit 3: ", o.Limit)
